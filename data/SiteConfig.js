module.exports = {
  ...
  siteTitle: "Test blog whith React.js", // Site title.
  ...
  userLocation: "Russia, Tambov", // User location to display in the author segment.
  ...
  userLinks: [
    ...
    {
      label: "Vkontakte",
      url: "https://vk.com/kasy28",
      iconClassName: "fa fa-vk"
    },
    {
      label: "Email",
      url: "mailto:anasteisha.mak@gmail.com",
      iconClassName: "fa fa-envelope"
    }
  ],
  copyright: "Copyright © 2018. Blog develop by TestUser" // Copyright string for the footer of the website and RSS feed.
};
